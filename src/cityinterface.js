...
$(document).ready(function () {
  ...
  $('#weatherLocation').click(function () {
    ...
    Promise.all([RestService, RestNumService]).then(function (values) {
      ...
      Promise.all([RestService, RestNumService, WeatherService]).then(function (values) {
        (async () => {
          let wikiService = new WikiService();
          const wikiResponse = await wikiService.getWikiByCity(city);
          getElements(wikiResponse);
        })();
        ...
        function getElements(wikiResponse) {
          ...
          console.log(wikiResponse.extract)
