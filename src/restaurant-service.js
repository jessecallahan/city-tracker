export class RestService {
  async getRestByNum(city1) {
    try {
      let response2 = await fetch(`https://developers.zomato.com/api/v2.1/search?entity_id=${city1}&entity_type=city&establishment_type=restaurant&apikey=${process.env.API_KEY}`);
